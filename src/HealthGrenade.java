...
public class HealthGrenade implements Abilities {
	...
	public void attack(HeistCharacter character, HeistCharacter enemy) {
		...
		if (rand.nextInt(100) + 1 <= chanceToHit) {
			...
			System.out.println(character.getName() + " tosses a healing grenade at their feet healing them " + "for "
					+ healthPoints + " bringing the their HP to " + character.getHitPoints());
		} else {
